...
template <class Hash, class Key,
    class Res = decltype(std::declval<Hash&>()(std::declval<Key>()))>
...
constexpr void test_hash_enabled(Key const& key = Key{}) {
...
using LibraryHashTypes = types::concatenate_t<types::arithmetic_types,
    types::type_list<Enum, EnumClass, void*, void const*, Class*,
        std::nullptr_t>>;
