...
// respective `value` subobjects are equal and their respective `this`
...
public:
    ...
    constexpr lvalue_adl_swappable& operator=(
        lvalue_adl_swappable other) noexcept {
        value_ = other.value_;
        return *this;
    }
    ...
    constexpr bool operator==(
        lvalue_adl_swappable const& other) const noexcept {
...
public:
    ...
    constexpr lvalue_rvalue_adl_swappable(
        lvalue_rvalue_adl_swappable&& other) noexcept
        : value_(std::move(other.value_))
        , this_(this) {}

    constexpr lvalue_rvalue_adl_swappable(
        lvalue_rvalue_adl_swappable const& other) noexcept
        : value_(other.value_)
        , this_(this) {}

    constexpr lvalue_rvalue_adl_swappable& operator=(
        lvalue_rvalue_adl_swappable other) noexcept {
        value_ = other.value_;
        return *this;
    }
    ...
    constexpr bool operator==(
        lvalue_rvalue_adl_swappable const& other) const noexcept {
        return value_ == other.value_ && this_ == this && other.this_ == &other;
    }
...
public:
    ...
    constexpr rvalue_lvalue_adl_swappable(
        rvalue_lvalue_adl_swappable&& other) noexcept
        : value_(std::move(other.value_))
        , this_(this) {}

    constexpr rvalue_lvalue_adl_swappable(
        rvalue_lvalue_adl_swappable const& other) noexcept
        : value_(other.value_)
        , this_(this) {}

    constexpr rvalue_lvalue_adl_swappable& operator=(
        rvalue_lvalue_adl_swappable other) noexcept {
        value_ = other.value_;
        return *this;
    }
    ...
    constexpr bool operator==(
        rvalue_lvalue_adl_swappable const& other) const noexcept {
        return value_ == other.value_ && this_ == this && other.this_ == &other;
    }
...
public:
    ...
    constexpr rvalue_adl_swappable& operator=(
        rvalue_adl_swappable other) noexcept {
        value_ = other.value_;
        return *this;
    }
    ...
    constexpr bool operator==(
        rvalue_adl_swappable const& other) const noexcept {
        return value_ == other.value_ && this_ == this && other.this_ == &other;
    }
...
public:
    ...
    constexpr non_move_constructible_adl_swappable& operator=(
        non_move_constructible_adl_swappable other) noexcept {
        value_ = other.value_;
        return *this;
    }
    ...
    constexpr bool operator==(
        non_move_constructible_adl_swappable const& other) const noexcept {
        return value_ == other.value_ && this_ == this && other.this_ == &other;
    }
...
public:
    ...
    non_move_assignable_adl_swappable(
        non_move_assignable_adl_swappable&& other) = delete;
    ...
    constexpr non_move_assignable_adl_swappable& operator=(
        non_move_assignable_adl_swappable&& other) noexcept = delete;
    ...
    constexpr bool operator==(
        non_move_assignable_adl_swappable const& other) const noexcept {
        return value_ == other.value_ && this_ == this && other.this_ == &other;
    }
...
public:
    ...
    constexpr throwable_adl_swappable(
        throwable_adl_swappable const& other) noexcept
        : value_(other.value_)
        , this_(this) {}

    constexpr throwable_adl_swappable& operator=(
        throwable_adl_swappable other) noexcept {
        value_ = other.value_;
        return *this;
    }
    ...
    constexpr bool operator==(
        throwable_adl_swappable const& other) const noexcept {
        return value_ == other.value_ && this_ == this && other.this_ == &other;
    }
