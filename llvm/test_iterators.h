...
template <class It> class cpp17_output_iterator {
  It it_;
...
public:
  ...
  template <class U>
  constexpr cpp17_output_iterator(const cpp17_output_iterator<U> &u)
...
template <class It> cpp17_output_iterator(It) -> cpp17_output_iterator<It>;
...
template <class It, class ItTraits = It> class cpp17_input_iterator {
...
public:
  ...
  constexpr cpp17_input_iterator(const cpp17_input_iterator<U, T> &u)
      : it_(u.it_), tracker_(u.tracker_) {}
  ...
  friend constexpr bool operator==(const cpp17_input_iterator &x,
                                   const cpp17_input_iterator &y) {
    return x.it_ == y.it_;
  }
  friend constexpr bool operator!=(const cpp17_input_iterator &x,
                                   const cpp17_input_iterator &y) {
...
template <class It> cpp17_input_iterator(It) -> cpp17_input_iterator<It>;

static_assert(std::input_iterator<cpp17_input_iterator<int *>>);

template <class It> class forward_iterator {
  It it_;
  support::double_move_tracker tracker_;
...
public:
  ...
  template <class U>
  constexpr forward_iterator(const forward_iterator<U> &u)
      : it_(u.it_), tracker_(u.tracker_) {}
  ...
  friend constexpr bool operator==(const forward_iterator &x,
...
template <class It> forward_iterator(It) -> forward_iterator<It>;

template <class It> class bidirectional_iterator {
  It it_;
  support::double_move_tracker tracker_;
...
public:
  ...
  template <class U>
  constexpr bidirectional_iterator(const bidirectional_iterator<U> &u)
      : it_(u.it_), tracker_(u.tracker_) {}
  ...
  friend constexpr bool operator==(const bidirectional_iterator &x,
                                   const bidirectional_iterator &y) {
    return x.it_ == y.it_;
  }
  friend constexpr bool operator!=(const bidirectional_iterator &x,
                                   const bidirectional_iterator &y) {
...
template <class It> bidirectional_iterator(It) -> bidirectional_iterator<It>;

template <class It> class random_access_iterator {
  It it_;
  support::double_move_tracker tracker_;
...
public:
  ...
  template <class U>
  constexpr random_access_iterator(const random_access_iterator<U> &u)
      : it_(u.it_), tracker_(u.tracker_) {}
  ...
  friend constexpr random_access_iterator operator+(random_access_iterator x,
                                                    difference_type n) {
    x += n;
    return x;
  }
  friend constexpr random_access_iterator operator+(difference_type n,
  ...
  friend constexpr difference_type operator-(random_access_iterator x,
                                             random_access_iterator y) {
    return x.it_ - y.it_;
  }

  friend constexpr bool operator==(const random_access_iterator &x,
...
template <class It> random_access_iterator(It) -> random_access_iterator<It>;
...
template <class It> class three_way_random_access_iterator {
  It it_;
  support::double_move_tracker tracker_;

  template <class U> friend class three_way_random_access_iterator;
...
public:
  ...
  constexpr three_way_random_access_iterator(
      const three_way_random_access_iterator<U> &u)
      : it_(u.it_), tracker_(u.tracker_) {}
  ...
  friend constexpr three_way_random_access_iterator
  ...
  operator-(three_way_random_access_iterator x,
  ...
  operator<=>(const three_way_random_access_iterator &x,
              const three_way_random_access_iterator &y) {
  ...
  friend constexpr It base(const three_way_random_access_iterator &i) {
    return i.it_;
  }
...
template <std::random_access_iterator It> class cpp20_random_access_iterator {
  It it_;
  support::double_move_tracker tracker_;
...
public:
  ...
  constexpr cpp20_random_access_iterator(
      const cpp20_random_access_iterator<U> &u)
      : it_(u.it_), tracker_(u.tracker_) {}
  ...
  friend constexpr cpp20_random_access_iterator
  ...
  friend constexpr difference_type operator-(cpp20_random_access_iterator x,
                                             cpp20_random_access_iterator y) {
    return x.it_ - y.it_;
  }

  friend constexpr bool operator==(const cpp20_random_access_iterator &x,
  ...
  friend constexpr It base(const cpp20_random_access_iterator &i) {
    return i.it_;
  }
...
template <std::contiguous_iterator It> class contiguous_iterator {
  It it_;
  support::double_move_tracker tracker_;

  template <std::contiguous_iterator U> friend class contiguous_iterator;
...
public:
  ...
  template <class U>
  constexpr contiguous_iterator(const contiguous_iterator<U> &u)
      : it_(u.it_), tracker_(u.tracker_) {}
  ...
  friend constexpr contiguous_iterator operator+(contiguous_iterator x,
                                                 difference_type n) {
    x += n;
    return x;
  }
  ...
  friend constexpr difference_type operator-(contiguous_iterator x,
                                             contiguous_iterator y) {
    return x.it_ - y.it_;
  }

  friend constexpr bool operator==(const contiguous_iterator &x,
                                   const contiguous_iterator &y) {
    return x.it_ == y.it_;
  }
  friend constexpr bool operator!=(const contiguous_iterator &x,
                                   const contiguous_iterator &y) {
...
template <class It> contiguous_iterator(It) -> contiguous_iterator<It>;

template <class It> class three_way_contiguous_iterator {
...
public:
  ...
  constexpr three_way_contiguous_iterator(
      const three_way_contiguous_iterator<U> &u)
      : it_(u.it_), tracker_(u.tracker_) {}
  ...
  friend constexpr three_way_contiguous_iterator
  ...
  friend constexpr difference_type operator-(three_way_contiguous_iterator x,
                                             three_way_contiguous_iterator y) {
    return x.it_ - y.it_;
  }

  friend constexpr auto operator<=>(const three_way_contiguous_iterator &x,
                                    const three_way_contiguous_iterator &y) {
    return x.it_ <=> y.it_;
  }
  friend constexpr bool operator==(const three_way_contiguous_iterator &x,
                                   const three_way_contiguous_iterator &y) {
    return x.it_ == y.it_;
  }
...
template <typename T> struct ThrowingIterator {
  typedef std::bidirectional_iterator_tag iterator_category;
  ...
  constexpr explicit ThrowingIterator(const T *first, const T *last,
                                      int index = 0,
  ...
  constexpr friend bool operator==(const ThrowingIterator &a,
                                   const ThrowingIterator &b) {
  ...
  template <class T2> void operator,(T2 const &) = delete;
...
template <typename T> struct NonThrowingIterator {
  typedef std::bidirectional_iterator_tag iterator_category;
  typedef std::ptrdiff_t difference_type;
  typedef const T value_type;
  typedef const T *pointer;
  ...
  friend bool operator==(const NonThrowingIterator &a,
                         const NonThrowingIterator &b) noexcept {
    bool atEndL = a.current_ == a.end_;
    bool atEndR = b.current_ == b.end_;
    if (atEndL != atEndR)
      return false; // one is at the end (or empty), the other is not.
...
template <class It> cpp20_input_iterator(It) -> cpp20_input_iterator<It>;

static_assert(std::input_iterator<cpp20_input_iterator<int *>>);

template <std::input_or_output_iterator> struct iter_value_or_void {
  using type = void;
};

template <std::input_iterator I> struct iter_value_or_void<I> {
  using type = std::iter_value_t<I>;
};

template <class It> class cpp20_output_iterator {
  It it_;
  support::double_move_tracker tracker_;
...
template <class It> cpp20_output_iterator(It) -> cpp20_output_iterator<It>;
...
template <class Base> struct common_input_iterator {
  Base it_;
  ...
  friend constexpr bool operator==(common_input_iterator const &,
                                   common_input_iterator const &) = default;
};
...
template <class It> class operation_counting_iterator {
public:
  ...
  using iterator_concept = std::conditional_t<
      ...
      std::conditional_t<
          ...
          std::conditional_t<
              std::bidirectional_iterator<It>, std::bidirectional_iterator_tag,
              std::conditional_t<
                  std::forward_iterator<It>, std::forward_iterator_tag,
  ...
  constexpr operation_counting_iterator(const operation_counting_iterator &o) {
    *this = o;
  }
  ...
  operator=(const operation_counting_iterator &o) = default;
  constexpr operation_counting_iterator &
  operator=(operation_counting_iterator &&o) {
    return *this = o;
  }
  ...
  friend constexpr operation_counting_iterator
  operator+(operation_counting_iterator it, difference_type n)
    requires std::random_access_iterator<It>
  {
    return it += n;
  }
  ...
  friend constexpr operation_counting_iterator
  operator+(difference_type n, operation_counting_iterator it)
    requires std::random_access_iterator<It>
  {
    return it += n;
  }
  ...
  friend constexpr difference_type
  operator-(operation_counting_iterator const &x,
...
template <class It> sentinel_wrapper(It) -> sentinel_wrapper<It>;

template <class It> class sized_sentinel {
public:
  ...
  friend constexpr auto operator-(const sized_sentinel &s, const It &i) {
    return s.base_ - base(i);
  }
  friend constexpr auto operator-(const It &i, const sized_sentinel &s) {
...
template <class It> sized_sentinel(It) -> sized_sentinel<It>;
...
template <class T> class rvalue_iterator {
public:
  using iterator_category = std::input_iterator_tag;
  using iterator_concept = std::random_access_iterator_tag;
  using difference_type = std::ptrdiff_t;
  ...
  constexpr friend rvalue_iterator operator+(difference_type n,
  ...
  constexpr difference_type operator-(const rvalue_iterator &other) const {
...
template <class T> rvalue_iterator(T *) -> rvalue_iterator<T>;
...
template <class T> struct ProxyDiffTBase {
  // Add default `operator<=>` so that the derived type, Proxy, can also use the
  // default `operator<=>`
  friend constexpr auto operator<=>(const ProxyDiffTBase &,
                                    const ProxyDiffTBase &) = default;
};
...
template <class T> inline constexpr bool IsProxy = false;

template <class T> inline constexpr bool IsProxy<Proxy<T>> = true;

template <class T> struct Proxy : ProxyDiffTBase<T> {
  T data;
  ...
  // of the implicitly declared one because of the user-provided copy assignment
  // operator.
...
// iter_move    -> Proxy<int&&>
template <class Base> struct ProxyIteratorBase {};
...
template <std::input_iterator Base> consteval auto get_iterator_concept() {
...
struct ProxyIterator : ProxyIteratorBase<Base> {
  ...
  friend constexpr decltype(auto) base(const ProxyIterator &p) {
    return base(p.base_);
  }
  ...
  friend constexpr Proxy<std::iter_rvalue_reference_t<Base>>
  ...
  friend constexpr void iter_swap(const ProxyIterator &x,
                                  const ProxyIterator &y) noexcept {
  ...
  friend constexpr bool operator==(const ProxyIterator &x,
  ...
  constexpr Proxy<std::iter_reference_t<Base>>
  ...
  friend constexpr auto operator<=>(const ProxyIterator &x,
                                    const ProxyIterator &y)
    requires(std::random_access_iterator<Base> &&
  ...
  friend constexpr ProxyIterator operator+(difference_type n,
                                           const ProxyIterator &x)
    requires std::random_access_iterator<Base>
  {
  ...
  friend constexpr difference_type operator-(const ProxyIterator &x,
                                             const ProxyIterator &y)
    requires std::random_access_iterator<Base>
  {
    return x.base_ - y.base_;
...
template <class Base> ProxyIterator(Base) -> ProxyIterator<Base>;
...
template <class BaseSent> struct ProxySentinel {
  BaseSent base_;
  ...
  friend constexpr bool operator==(const ProxyIterator<Base> &p,
                                   const ProxySentinel &sent) {
    return p.base_ == sent.base_;
  }
};
template <class BaseSent> ProxySentinel(BaseSent) -> ProxySentinel<BaseSent>;
...
namespace util {
template <class Derived, class Iter> class iterator_wrapper {
  Iter iter_;
...
public:
  ...
  friend decltype(iter_ - iter_) operator-(const iterator_wrapper &lhs,
  ...
  friend bool operator==(const iterator_wrapper &lhs,
                         const iterator_wrapper &rhs) {
    return lhs.iter_ == rhs.iter_;
  }
  friend bool operator!=(const iterator_wrapper &lhs,
