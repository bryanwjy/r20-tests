...
// Test SFINAE.
static_assert(
    HasOperatorGreaterThan<__RXX optional<ThreeWayComparable>, int>);
static_assert(HasOperatorGreaterThan<__RXX optional<ThreeWayComparable>,
    ThreeWayComparable>);

static_assert(
    !HasOperatorGreaterThan<__RXX optional<NonComparable>, NonComparable>);
static_assert(!HasOperatorGreaterThan<__RXX optional<ThreeWayComparable>,
    NonComparable>);
static_assert(!HasOperatorGreaterThan<__RXX optional<NonComparable>,
    ThreeWayComparable>);

static_assert(HasOperatorGreaterThan<int, __RXX optional<ThreeWayComparable>>);
static_assert(HasOperatorGreaterThan<ThreeWayComparable,
    __RXX optional<ThreeWayComparable>>);

static_assert(
    !HasOperatorGreaterThan<NonComparable, __RXX optional<NonComparable>>);
