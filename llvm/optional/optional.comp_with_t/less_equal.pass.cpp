...
// Test SFINAE.
static_assert(
    HasOperatorLessThanEqual<__RXX optional<ThreeWayComparable>, int>);
static_assert(HasOperatorLessThanEqual<__RXX optional<ThreeWayComparable>,
    ThreeWayComparable>);

static_assert(
    !HasOperatorLessThanEqual<__RXX optional<NonComparable>, NonComparable>);
static_assert(!HasOperatorLessThanEqual<__RXX optional<ThreeWayComparable>,
    NonComparable>);
static_assert(!HasOperatorLessThanEqual<__RXX optional<NonComparable>,
    ThreeWayComparable>);

static_assert(
    HasOperatorLessThanEqual<int, __RXX optional<ThreeWayComparable>>);
static_assert(HasOperatorLessThanEqual<ThreeWayComparable,
    __RXX optional<ThreeWayComparable>>);

static_assert(
    !HasOperatorLessThanEqual<NonComparable, __RXX optional<NonComparable>>);
