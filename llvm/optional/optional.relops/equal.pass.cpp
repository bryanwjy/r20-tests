...
static_assert(HasOperatorEqual<__RXX optional<int>>);
static_assert(HasOperatorEqual<__RXX optional<EqualityComparable>>);
static_assert(HasOperatorEqual<__RXX optional<EqualityComparable>,
    __RXX optional<int>>);

static_assert(!HasOperatorEqual<__RXX optional<NonComparable>>);
static_assert(!HasOperatorEqual<__RXX optional<EqualityComparable>,
