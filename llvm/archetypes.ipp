...
struct AllCtors : DEFINE_BASE(AllCtors) {
    ...
    using Base::Base;
    using Base::operator=;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR AllCtors()
        DEFINE_NOEXCEPT DEFINE_DEFAULT_CTOR;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR AllCtors(
        AllCtors const&) DEFINE_NOEXCEPT DEFINE_CTOR;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR AllCtors(
        AllCtors&&) DEFINE_NOEXCEPT DEFINE_CTOR;
    DEFINE_ASSIGN_CONSTEXPR AllCtors& operator=(
        AllCtors const&) DEFINE_NOEXCEPT DEFINE_ASSIGN;
    DEFINE_ASSIGN_CONSTEXPR AllCtors& operator=(
        AllCtors&&) DEFINE_NOEXCEPT DEFINE_ASSIGN;
...
struct DefaultOnly : DEFINE_BASE(DefaultOnly) {
    ...
    using Base::Base;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR DefaultOnly()
        DEFINE_NOEXCEPT DEFINE_DEFAULT_CTOR;
...
struct Copyable : DEFINE_BASE(Copyable) {
    ...
    using Base::Base;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR Copyable()
        DEFINE_NOEXCEPT DEFINE_DEFAULT_CTOR;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR Copyable(
        Copyable const&) DEFINE_NOEXCEPT DEFINE_CTOR;
...
struct CopyOnly : DEFINE_BASE(CopyOnly) {
    ...
    using Base::Base;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR CopyOnly()
        DEFINE_NOEXCEPT DEFINE_DEFAULT_CTOR;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR CopyOnly(
        CopyOnly const&) DEFINE_NOEXCEPT DEFINE_CTOR;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR CopyOnly(
        CopyOnly&&) DEFINE_NOEXCEPT = delete;
...
struct NonCopyable : DEFINE_BASE(NonCopyable) {
    ...
    using Base::Base;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR NonCopyable()
        DEFINE_NOEXCEPT DEFINE_DEFAULT_CTOR;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR NonCopyable(
        NonCopyable const&) DEFINE_NOEXCEPT = delete;
...
struct MoveOnly : DEFINE_BASE(MoveOnly) {
    ...
    using Base::Base;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR MoveOnly()
        DEFINE_NOEXCEPT DEFINE_DEFAULT_CTOR;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR MoveOnly(
        MoveOnly&&) DEFINE_NOEXCEPT DEFINE_CTOR;
...
struct CopyAssignable : DEFINE_BASE(CopyAssignable) {
    ...
    CopyAssignable& operator=(
        CopyAssignable const&) DEFINE_NOEXCEPT DEFINE_ASSIGN;
...
struct CopyAssignOnly : DEFINE_BASE(CopyAssignOnly) {
    ...
    CopyAssignOnly& operator=(
        CopyAssignOnly const&) DEFINE_NOEXCEPT DEFINE_ASSIGN;
...
struct ConvertingType : DEFINE_BASE(ConvertingType) {
    ...
    using Base::Base;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR ConvertingType()
        DEFINE_NOEXCEPT DEFINE_DEFAULT_CTOR;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR ConvertingType(
        ConvertingType const&) DEFINE_NOEXCEPT DEFINE_CTOR;
    DEFINE_EXPLICIT DEFINE_CONSTEXPR ConvertingType(
        ConvertingType&&) DEFINE_NOEXCEPT DEFINE_CTOR;
    ConvertingType& operator=(
        ConvertingType const&) DEFINE_NOEXCEPT DEFINE_ASSIGN;
    ...
    template <class Arg>
    ConvertingType& operator=(Arg&&) DEFINE_NOEXCEPT {
        return *this;
    }
...
using ApplyTypes = List<AllCtors, NoCtors, NoDefault, DefaultOnly, Copyable,
    CopyOnly, NonCopyable, MoveOnly, CopyAssignable, CopyAssignOnly,
    MoveAssignOnly, ConvertingType>;
