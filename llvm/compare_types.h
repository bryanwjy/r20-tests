...
// `noexcept` specifiers deliberately imperfect since not all programmers bother
// to put the specifiers on their overloads.
...
struct cxx20_friend_eq {
    friend bool operator==(
        cxx20_friend_eq const&, cxx20_friend_eq const&) = default;
};
...
struct one_member_one_friend {
    friend boolean operator==(
        one_member_one_friend, one_member_one_friend) noexcept;
...
struct cxx20_member_eq_operator_with_deleted_ne {
    bool operator==(
        cxx20_member_eq_operator_with_deleted_ne const&) const = default;
    bool operator!=(
        cxx20_member_eq_operator_with_deleted_ne const&) const = delete;
};
...
struct member_three_way_comparable_with_deleted_eq {
    ...
    bool operator==(
        member_three_way_comparable_with_deleted_eq const&) const = delete;
};
...
struct member_three_way_comparable_with_deleted_ne {
    ...
    bool operator!=(
        member_three_way_comparable_with_deleted_ne const&) const = delete;
};
...
static_assert(
    requires(explicit_operators const x, one_way_ne const y) { x != y; });
...
struct eq_returns_explicit_bool {
    friend explicit_bool operator==(
        eq_returns_explicit_bool, eq_returns_explicit_bool);
    ...
    friend explicit_bool operator==(
        eq_returns_explicit_bool, totally_ordered_with_others);
    friend explicit_bool operator==(
        totally_ordered_with_others, eq_returns_explicit_bool);
    friend bool operator!=(
        eq_returns_explicit_bool, totally_ordered_with_others);
    friend bool operator!=(
        totally_ordered_with_others, eq_returns_explicit_bool);
...
struct ne_returns_explicit_bool {
    ...
    friend explicit_bool operator!=(
        ne_returns_explicit_bool, ne_returns_explicit_bool);
    friend bool operator<(ne_returns_explicit_bool, ne_returns_explicit_bool);
    friend bool operator>(ne_returns_explicit_bool, ne_returns_explicit_bool);
    friend bool operator<=(ne_returns_explicit_bool, ne_returns_explicit_bool);
    friend bool operator>=(ne_returns_explicit_bool, ne_returns_explicit_bool);
    ...
    friend bool operator==(
        ne_returns_explicit_bool, totally_ordered_with_others);
    friend explicit_bool operator!=(
        ne_returns_explicit_bool, totally_ordered_with_others);
    friend explicit_bool operator!=(
        totally_ordered_with_others, ne_returns_explicit_bool);
    friend bool operator<(
        ne_returns_explicit_bool, totally_ordered_with_others);
    friend bool operator<(
        totally_ordered_with_others, ne_returns_explicit_bool);
...
struct lt_returns_explicit_bool {
    ...
    friend bool operator!=(lt_returns_explicit_bool, lt_returns_explicit_bool);
    friend explicit_bool operator<(
        lt_returns_explicit_bool, lt_returns_explicit_bool);
    friend bool operator>(lt_returns_explicit_bool, lt_returns_explicit_bool);
    friend bool operator<=(lt_returns_explicit_bool, lt_returns_explicit_bool);
    friend bool operator>=(lt_returns_explicit_bool, lt_returns_explicit_bool);
    ...
    friend bool operator==(
        lt_returns_explicit_bool, totally_ordered_with_others);
    friend bool operator!=(
        lt_returns_explicit_bool, totally_ordered_with_others);
    friend bool operator!=(
        totally_ordered_with_others, lt_returns_explicit_bool);
    friend explicit_bool operator<(
        lt_returns_explicit_bool, totally_ordered_with_others);
    friend bool operator<(
        totally_ordered_with_others, lt_returns_explicit_bool);
...
struct gt_returns_explicit_bool {
    ...
    friend bool operator<(gt_returns_explicit_bool, gt_returns_explicit_bool);
    friend explicit_bool operator>(
        gt_returns_explicit_bool, gt_returns_explicit_bool);
    friend bool operator<=(gt_returns_explicit_bool, gt_returns_explicit_bool);
    friend bool operator>=(gt_returns_explicit_bool, gt_returns_explicit_bool);
    ...
    friend bool operator==(
        gt_returns_explicit_bool, totally_ordered_with_others);
    friend bool operator!=(
        gt_returns_explicit_bool, totally_ordered_with_others);
    friend bool operator!=(
        totally_ordered_with_others, gt_returns_explicit_bool);
    friend bool operator<(
        gt_returns_explicit_bool, totally_ordered_with_others);
    friend bool operator<(
        totally_ordered_with_others, gt_returns_explicit_bool);
...
struct le_returns_explicit_bool {
    ...
    friend bool operator>(le_returns_explicit_bool, le_returns_explicit_bool);
    friend explicit_bool operator<=(
        le_returns_explicit_bool, le_returns_explicit_bool);
    friend bool operator>=(le_returns_explicit_bool, le_returns_explicit_bool);

    operator totally_ordered_with_others() const;

    friend bool operator==(
        le_returns_explicit_bool, totally_ordered_with_others);
    friend bool operator!=(
        le_returns_explicit_bool, totally_ordered_with_others);
    friend bool operator!=(
        totally_ordered_with_others, le_returns_explicit_bool);
    friend bool operator<(
        le_returns_explicit_bool, totally_ordered_with_others);
    friend bool operator<(
        totally_ordered_with_others, le_returns_explicit_bool);
...
struct ge_returns_explicit_bool {
    ...
    friend bool operator<=(ge_returns_explicit_bool, ge_returns_explicit_bool);
    friend explicit_bool operator>=(
        ge_returns_explicit_bool, ge_returns_explicit_bool);

    operator totally_ordered_with_others() const;

    friend bool operator==(
        ge_returns_explicit_bool, totally_ordered_with_others);
    friend bool operator!=(
        ge_returns_explicit_bool, totally_ordered_with_others);
    friend bool operator!=(
        totally_ordered_with_others, ge_returns_explicit_bool);
    friend bool operator<(
        ge_returns_explicit_bool, totally_ordered_with_others);
    friend bool operator<(
        totally_ordered_with_others, ge_returns_explicit_bool);
...
struct returns_true_type {
    ...
    friend std::true_type operator==(
        returns_true_type, totally_ordered_with_others);
    friend std::true_type operator==(
        totally_ordered_with_others, returns_true_type);
    friend std::true_type operator!=(
        returns_true_type, totally_ordered_with_others);
    friend std::true_type operator!=(
        totally_ordered_with_others, returns_true_type);
...
struct ForwardingTestObject {
    ...
    constexpr bool operator<(ForwardingTestObject const&) const& {
        return false;
    }
