...
void test_range_and_pattern_deduction_guide() {
    { // Both `v` and `pat` model `xranges::view`.
        {
            View v;
            Pattern pat;
    ...
    { // Only `pat` models `xranges::view`.
        {
            Range v;
            Pattern pat;
            xranges::join_with_view view(v, pat);
            static_assert(std::is_same_v<decltype(view),
                xranges::join_with_view<xranges::ref_view<Range>, Pattern>>);
        }
        {
            Range v;
            xranges::join_with_view view(v, Pattern{});
        ...
        }
        {
            ...
            static_assert(std::is_same_v<decltype(view),
                xranges::join_with_view<xranges::owning_view<Range>, Pattern>>);
        }
        {
    ...
    { // Only `v` models `xranges::view`.
        ...
        }
        {
            ...
            static_assert(std::is_same_v<decltype(view),
                xranges::join_with_view<View,
                    xranges::owning_view<RangePattern>>>);
        }
        {
            RangePattern pat;
            xranges::join_with_view view(View{}, pat);
    ...
    { // Both `v` and `pat` don't model `xranges::view`.
        {
            Range r;
            RangePattern pat;
            xranges::join_with_view view(r, pat);
            static_assert(std::is_same_v<decltype(view),
                xranges::join_with_view<xranges::ref_view<Range>,
                    xranges::ref_view<RangePattern>>>);
        }
        {
            Range r;
        ...
        }
        {
            ...
            xranges::join_with_view view(Range{}, pat);
            static_assert(std::is_same_v<decltype(view),
                xranges::join_with_view<xranges::owning_view<Range>,
                    xranges::ref_view<RangePattern>>>);
        }
        {
