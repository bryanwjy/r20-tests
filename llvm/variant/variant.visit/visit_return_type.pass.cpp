...
void test_call_operator_forwarding() {
    ...
    { // test call operator forwarding - no variant
        __RXX visit<ReturnType>(obj);
        assert(Fn::check_call<>(CT_NonConst | CT_LValue));
        __RXX visit<ReturnType>(cobj);
        assert(Fn::check_call<>(CT_Const | CT_LValue));
        __RXX visit<ReturnType>(std::move(obj));
        assert(Fn::check_call<>(CT_NonConst | CT_RValue));
        __RXX visit<ReturnType>(std::move(cobj));
        assert(Fn::check_call<>(CT_Const | CT_RValue));
    }
    { // test call operator forwarding - single variant, single arg
        using V = __RXX variant<int>;
        V v(42);
        __RXX visit<ReturnType>(obj, v);
        assert(Fn::check_call<int&>(CT_NonConst | CT_LValue));
        __RXX visit<ReturnType>(cobj, v);
        assert(Fn::check_call<int&>(CT_Const | CT_LValue));
        __RXX visit<ReturnType>(std::move(obj), v);
        assert(Fn::check_call<int&>(CT_NonConst | CT_RValue));
        __RXX visit<ReturnType>(std::move(cobj), v);
    ...
    }
    {
        ...
        __RXX visit<ReturnType>(obj, v1, v2, v3, v4);
        assert((Fn::check_call<long&, std::string&, int&, double&>(
            CT_NonConst | CT_LValue)));
        __RXX visit<ReturnType>(cobj, v1, v2, v3, v4);
        assert((Fn::check_call<long&, std::string&, int&, double&>(
            CT_Const | CT_LValue)));
        __RXX visit<ReturnType>(std::move(obj), v1, v2, v3, v4);
        assert((Fn::check_call<long&, std::string&, int&, double&>(
            CT_NonConst | CT_RValue)));
        __RXX visit<ReturnType>(std::move(cobj), v1, v2, v3, v4);
        assert((Fn::check_call<long&, std::string&, int&, double&>(
            CT_Const | CT_RValue)));
    }
    {
...
void test_argument_forwarding() {
    ...
    { // single argument - value type
        ...
        __RXX visit<ReturnType>(obj, cv);
        assert(Fn::check_call<int const&>(Val));
        __RXX visit<ReturnType>(obj, std::move(v));
        assert(Fn::check_call<int&&>(Val));
        __RXX visit<ReturnType>(obj, std::move(cv));
        assert(Fn::check_call<int const&&>(Val));
    }
    { // multi argument - multi variant
        using V = __RXX variant<int, std::string, long>;
        V v1(42), v2("hello"), v3(43l);
        __RXX visit<ReturnType>(obj, v1, v2, v3);
        assert((Fn::check_call<int&, std::string&, long&>(Val)));
        __RXX visit<ReturnType>(
    ...
    }
    {
        ...
        __RXX visit<ReturnType>(obj, std::as_const(v1), std::as_const(v2),
            std::move(v3), std::move(v4));
        assert(
...
void test_return_type() {
    ...
    Fn const& cobj = obj;
    { // test call operator forwarding - no variant
        static_assert(std::is_same_v<decltype(__RXX visit<ReturnType>(obj)),
            ReturnType>);
        static_assert(std::is_same_v<decltype(__RXX visit<ReturnType>(cobj)),
            ReturnType>);
        static_assert(
            std::is_same_v<decltype(__RXX visit<ReturnType>(std::move(obj))),
                ReturnType>);
        static_assert(
            std::is_same_v<decltype(__RXX visit<ReturnType>(std::move(cobj))),
                ReturnType>);
    }
    { // test call operator forwarding - single variant, single arg
        using V = __RXX variant<int>;
        V v(42);
        static_assert(
            std::is_same_v<decltype(__RXX visit<ReturnType>(obj, v)),
                ReturnType>);
        static_assert(
            std::is_same_v<decltype(__RXX visit<ReturnType>(cobj, v)),
                ReturnType>);
    ...
    { // test call operator forwarding - multi variant, multi arg
        ...
        V2 v2("hello");
        static_assert(
            std::is_same_v<decltype(__RXX visit<ReturnType>(obj, v, v2)),
                ReturnType>);
        static_assert(
            std::is_same_v<decltype(__RXX visit<ReturnType>(cobj, v, v2)),
                ReturnType>);
        static_assert(std::is_same_v<decltype(__RXX visit<ReturnType>(
                                         std::move(obj), v, v2)),
            ReturnType>);
...
void test_constexpr_void() {
    ...
    constexpr ReturnArity aobj{};
    {
        using V = __RXX variant<int>;
        constexpr V v(42);
        static_assert((__RXX visit<void>(obj, v), 42) == 42, "");
    }
    {
...
void test_constexpr_int() {
    ...
    constexpr ReturnArity aobj{};
    {
        using V = __RXX variant<int>;
        constexpr V v(42);
        static_assert(__RXX visit<int>(obj, v) == 42, "");
    }
    {
        using V = __RXX variant<short, long, char>;
        constexpr V v(42l);
...
void test_exceptions() {
    ...
    auto test = [&](auto&&... args) {
        try {
            __RXX visit<ReturnType>(obj, args...);
...
template <typename T,
    typename = decltype(__RXX visit<bool>(
...
void test_sfinae() {
    ...
    static_assert(has_visit<__RXX variant<int>>(int()));
