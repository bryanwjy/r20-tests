...
struct NonTrivialMoveAssign {
    NonTrivialMoveAssign& operator=(NonTrivialMoveAssign const&) = default;
    NonTrivialMoveAssign& operator=(NonTrivialMoveAssign&&) { return *this; }
};

struct NonTrivialAssign {
    NonTrivialAssign& operator=(NonTrivialAssign const&) { return *this; }
    NonTrivialAssign& operator=(NonTrivialAssign&&) { return *this; }
};

struct NonTrivialAll {
    ~NonTrivialAll() {}
    NonTrivialAll& operator=(NonTrivialAll const&) { return *this; }
...
constexpr bool check =
    std::is_nothrow_default_constructible_v<__RXX optional<T>>;
