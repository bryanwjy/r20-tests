...
concept eq_comparable_impl =
    requires(__RXX optional<T> const& t, __RXX optional<U> const& u) {
        t == u;
        *t == u;
        t == *u;
    };
...
concept eq_comparable = eq_comparable_impl<T, U>
#  if RXX_SUPPORTS_OPTIONAL_REFERENCES
    && eq_comparable_impl<T&, U&> && eq_comparable_impl<T const&, U const&> &&
    eq_comparable_impl<T const&, U&> && eq_comparable_impl<T, U const&> &&
...
template <typename T, typename U = T>
concept ne_comparable = ne_comparable_impl<T, U>
#  if RXX_SUPPORTS_OPTIONAL_REFERENCES
    && ne_comparable_impl<T&, U&> && ne_comparable_impl<T const&, U const&> &&
    ne_comparable_impl<T const&, U&> && ne_comparable_impl<T, U const&> &&
...
template <typename T, typename U = T>
concept lt_comparable = lt_comparable_impl<T, U>
#  if RXX_SUPPORTS_OPTIONAL_REFERENCES
    && lt_comparable_impl<T&, U&> && lt_comparable_impl<T const&, U const&> &&
    lt_comparable_impl<T const&, U&> && lt_comparable_impl<T, U const&> &&
...
template <typename T, typename U = T>
concept le_comparable = le_comparable_impl<T, U>
#  if RXX_SUPPORTS_OPTIONAL_REFERENCES
    && le_comparable_impl<T&, U&> && le_comparable_impl<T const&, U const&> &&
    le_comparable_impl<T const&, U&> && le_comparable_impl<T, U const&> &&
...
template <typename T, typename U = T>
concept gt_comparable = gt_comparable_impl<T, U>
#  if RXX_SUPPORTS_OPTIONAL_REFERENCES
    && gt_comparable_impl<T&, U&> && gt_comparable_impl<T const&, U const&> &&
    gt_comparable_impl<T const&, U&> && gt_comparable_impl<T, U const&> &&
...
template <typename T, typename U = T>
concept ge_comparable = ge_comparable_impl<T, U>
#  if RXX_SUPPORTS_OPTIONAL_REFERENCES
    && ge_comparable_impl<T&, U&> && ge_comparable_impl<T const&, U const&> &&
    ge_comparable_impl<T const&, U&> && ge_comparable_impl<T, U const&> &&
...
struct E {};
bool operator==(/* not-const */ E&, E const&);
