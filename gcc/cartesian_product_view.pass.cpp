...
constexpr bool test01() {
  ...
  VERIFY(ranges::equal(v2 | views::reverse | views::keys,
                       (int[]){3, 3, 3, 2, 2, 2, 1, 1, 1}));
  VERIFY(ranges::equal(v2 | views::reverse | views::values,
                       (int[]){6, 5, 4, 6, 5, 4, 6, 5, 4}));

  auto v3 = rxx::views::cartesian_product(x, y, z);
  VERIFY(ranges::size(v3) == 18);
  VERIFY(ranges::equal(v3, (std::tuple<int, int, int>[]){{1, 4, 7},
                                                         {1, 4, 8},
                                                         {1, 5, 7},
                                                         {1, 5, 8},
                                                         {1, 6, 7},
  ...
  VERIFY(ranges::equal(v4 | views::elements<3>, rxx::views::repeat(9, 18)));
